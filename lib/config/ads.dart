...
///
/// [isPremium] は呼び出し元（[AdBannerSlot]）が渡す実効プレミアムの確定値
/// （既存の `isPremiumOrAdminProvider`——プレミアムまたはサイト管理者——の
/// `AsyncValue<bool>` を解決したもの）を渡す。**新しいプレミアム判定を作らない**
/// ——判定が2つあると、片方だけ直したときに「課金したのに広告が消えない」が起きる。
///
